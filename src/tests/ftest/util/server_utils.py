...
from server_utils_params import (DaosServerTelemtryCredentials, DaosServerTransportCredentials,
...
def get_server_command(group, cert_dir, bin_dir, config_file, config_temp=None):
    ...
    config.telemetry_config = DaosServerTelemtryCredentials(cert_dir)
